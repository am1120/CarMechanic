...
public class searchresultsservlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success == 1) {
            ...
            request.setAttribute("result2", "Search Successfull");
            request.setAttribute("searchresult",request.getAttribute("searchresult"));
            ...
            request.setAttribute("result",
                    "Search result: " + request.getAttribute("error"));
        }
